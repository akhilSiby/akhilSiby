...
- Build and enhance features for **MissionOS** — a real-time geotechnical & construction management platform
- Collaborate with clients and internal teams to tailor solutions for seamless project integration
...
- 🔧 Upgrading and stabilizing a large-scale legacy codebase in a live production environment
- 📄 Optimizing critical backend pipelines for significant performance improvements
...
- 🧪 Building personal projects to explore modern backend and frontend patterns beyond what the day job demands
...
- Geospatial & GIS-integrated systems
- Temporal data modeling & time-based correctness
...
|---------|-------------|-------|
| **Spotlfy** | Spotify clone with synchronized group listening via Socket.io and CI/CD pipelines | MERN, Socket.io |
| **PrintX E-Commerce** | Full-featured online store for a 3D printing company — products, auth, orders, payments | PHP, MySQL, Razorpay |
